...
class DummyXdsChannelCredsFactory : public XdsChannelCredsFactory {
 public:
  ...
  const char* creds_type() const override { return "dummy"; }
};

TEST(XdsChannelCredsRegistryTest, DefaultCreds) {
  // Default creds.
